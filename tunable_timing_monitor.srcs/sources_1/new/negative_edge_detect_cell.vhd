...
entity negative_edge_detect_cell is
  Port ( B : in std_logic;
         A : in std_logic;
        clk : in std_logic;  
        ...
        attribute dont_touch of negative_edge_detect_cell : entity is "true";
end negative_edge_detect_cell;

architecture Behavioral of negative_edge_detect_cell is
...
xor_output : XNOR_gate port map (A => A , B => interA , output => xnor_out);
